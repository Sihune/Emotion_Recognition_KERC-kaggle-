...
from keras.layers import Input, Conv2D, Activation, BatchNormalization, add, Reshape
...
def Vggface2_ResNet50_Base(weights_path = None):
    ...
    inputs = Input(shape=(80, 80, 3), name='base_input')
...
def Vggface2_ResNet50(input_dim=(80, 80, 3), nb_classes=8631, optimizer='sgd', mode='train'):
    # inputs are of size 224 x 224 x 3
